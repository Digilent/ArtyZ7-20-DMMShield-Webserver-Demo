...
set_property -dict { PACKAGE_PIN U13   IOSTANDARD LVCMOS33 } [get_ports { gpio_tri_o[6] }]; #IO_L3P_T0_DQS_PUDC_B_34 Sch=CK_IO2 - DMMShield: RLI
set_property -dict { PACKAGE_PIN V13   IOSTANDARD LVCMOS33 } [get_ports { gpio_tri_o[5] }]; #IO_L3N_T0_DQS_34 Sch=CK_IO3        - DMMShield: RLU
set_property -dict { PACKAGE_PIN V15   IOSTANDARD LVCMOS33 } [get_ports { gpio_tri_o[4] }]; #IO_L10P_T1_34 Sch=CK_IO4           - DMMShield: RLD
...
set_property -dict { PACKAGE_PIN V18   IOSTANDARD LVCMOS33 } [get_ports { gpio_tri_o[0] }]; #IO_L21N_T3_DQS_34 Sch=CK_IO9       - DMMShield: CS_Eprom
set_property -dict { PACKAGE_PIN T16   IOSTANDARD LVCMOS33 } [get_ports { gpio_tri_o[1] }]; #IO_L9P_T1_DQS_34 Sch=CK_IO10       - DMMShield: CS_DMM
set_property -dict { PACKAGE_PIN R17   IOSTANDARD LVCMOS33 } [get_ports { gpio2_tri_i[0] }]; #IO_L19N_T3_VREF_34 Sch=CK_IO11    - DMMShield: MISO (DO)
set_property -dict { PACKAGE_PIN P18   IOSTANDARD LVCMOS33 } [get_ports { gpio_tri_o[3] }]; #IO_L23N_T3_34 Sch=CK_IO12          - DMMShield: MOSI (DI)
set_property -dict { PACKAGE_PIN N17   IOSTANDARD LVCMOS33 } [get_ports { gpio_tri_o[2] }]; #IO_L23P_T3_34 Sch=CK_IO13          - DMMShield: SPI CLK	
